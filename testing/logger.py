...
class Logger:
    def __init__(self):
        ...
        axes = plt.gca()
        axes.set_xlim([0,self.num_tests])
    ...
    def plot_test_times(self,test_times_1,test_times_2,num_iters,label_1,label_2):
        plt.plot(num_iters,test_times_1,label=label_1)
    ...
    def plot_test_costs(self,test_costs_1,test_costs_2,num_iters,label_1,label_2):
        plt.plot(num_iters,test_costs_1,label=label_1)
        plt.plot(num_iters,test_costs_2,label=label_2)
        plt.show()